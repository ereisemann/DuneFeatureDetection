...
indir = 'F:\TX_2016_NCMP\TX_2016_Zone15_MissingPiece\';
outdir = 'F:\TX_2016_NCMP\TX_2016_Zone15_MissingPiece\Output\';
SLbase = 'TX_NCMP_2016_';
...
%  for jj = 1:nn
   ...
   tiff = char(GRIDS(jj));
   blocknum = tiff(12); % CHANGE for different file names
%    blocknum = jj;
   blocknum
